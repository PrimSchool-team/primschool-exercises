ps.francais.determinants.View = function (mdl, u, div, number, min, max, sh) {
...
// xs device
    ...
    this.next = function () {
        ...
        $('#image_md_lg').attr('src',
            url + 'exercises/ps/francais/lelales/img/card_' + model.getImageIndex() + '.png');
        $('#image_sm').attr('src',
            url + 'exercises/ps/francais/lelales/img/card_' + model.getImageIndex() + '.png');
        $('#image_xs').attr('src',
            url + 'exercises/ps/francais/lelales/img/card_' + model.getImageIndex() + '.png');
    ...
    var build_image = function (image_div, i, style) {
        ...
        if (style === "md_lg") {
            img = $('<img/>', {
                ...
                src: url + 'exercises/ps/francais/lelales/img/card_' + i + '.png',
                height: height / 2,
                id: 'image_md_lg'
            });
            word_div = $('<div/>', {
