ps.francais.ununedes.Model = function (number, min, max, sh) {
    ...
    this.base = ps.francais.determinants.Model;

    this.init(number, min, max, sh);
};

ps.francais.ununedes.Model.prototype = new ps.francais.determinants.Model;