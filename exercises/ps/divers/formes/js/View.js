ps.divers.formes.View = function (mdl, div, i, s, sd) {
...
// public methods
    ...
    this.init = function (mdl, view, i, s, sd) {
        module = mdl;
        model = new ps.divers.formes.Model(i, s, sd);
        init_div(view);
        controller = new ps.divers.formes.Controller(model, this);
    };
        ...
        if (style === "md_lg") {
            ...
            $('<img />', {
                ...
                height: 50
                    ...
                    var mySound = new buzz.sound('exercises/ps/divers/formes/sounds/'+
                        model.getSound()+'.ogg');
                    mySound.play();
                }).appendTo(text_md_lg);
