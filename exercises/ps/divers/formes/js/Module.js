ps.divers.formes.Module = function (e) {
...
// xs devices
        ...
        var image = $('<img/>', {
            style: 'width: 80%',
            src: 'exercises/ps/divers/formes/img/example2.png'
        });
...
// xs devices
        ...
        var image = $('<img/>', {
            style: 'width: 80%',
            src: 'exercises/ps/divers/formes/img/example.png'
        });
    ...
    this.buildQuestion = function (div, currentExercise, currentModule) {
        if (currentExercise == 1) {
            if (currentModule == 1) {
                view = new ps.divers.formes.View(this, div,
                    [
