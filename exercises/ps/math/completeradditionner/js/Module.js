ps.math.completeradditionner.Module = function (e) {
...
// xs devices
        ...
        var image = $('<img/>', {
            style: 'width: 50%',
            src: 'exercises/ps/math/completeradditionner/img/card_5.png'
        });
...
// xs devices
        ...
        var image = $('<img/>', {
            style: 'width: 80%',
            src: 'exercises/ps/math/completeradditionner/img/example.png'
        });
    ...
    this.buildQuestion = function (div, currentExercise, currentModule) {
        if (currentExercise == 1) {
            view = new ps.math.completeradditionner.View(this, div, 5, 5);
        } else if (currentExercise == 2) {
            view = new ps.math.completeradditionner.View(this, div, 5, 6);
        } else if (currentExercise == 3) {
            view = new ps.math.completeradditionner.View(this, div, 5, 8);
        } else if (currentExercise == 4) {
            view = new ps.math.completeradditionner.View(this, div, 5, 10);
        } else if (currentExercise == 5) {
            view = new ps.math.completeradditionner.View(this, div, 5, 12);
        }
        questionIndex = 1;
