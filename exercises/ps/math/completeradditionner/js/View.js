ps.math.completeradditionner.View = function (mdl, div, number, max) {
...
// public methods
    ...
    this.init = function (mdl, view, number, max) {
        ...
        module = mdl;
        model = new ps.math.completeradditionner.Model(number, max);
        init_div(view);
        controller = new ps.math.completeradditionner.Controller(model, this);
    };
...
// md and lg devices
        $('#img_operand_1_md_lg').attr('src',
            'exercises/ps/math/completeradditionner/img/card_' + model.getFirstOperand() + '.png');
        $('#img_operand_2_md_lg').attr('src',
            'exercises/ps/math/completeradditionner/img/card_' + model.getSecondOperand() + '.png');
        $('#img_result_md_lg').attr('src',
            'exercises/ps/math/completeradditionner/img/card_0.png');
...
// xs and sm devices
    ...
    this.update = function () {
        ...
        if (model.isOkResult()) {
            ...
            $('#img_result_md_lg').attr('src', 'exercises/ps/math/completeradditionner/img/card_' +
                model.getResult() + '.png');
            $('#img_result_xs_sm').attr('src', 'exercises/ps/math/completeradditionner/img/card_' +
                model.getResult() + '.png');
            module.next();
        } else {
            $('#result_md_lg').html('?');
...
// private methods
    ...
    var build_image = function (i, name, style) {
        if (style === 'md_lg') {
            return $('<img/>', {
                src: 'exercises/ps/math/completeradditionner/img/card_' + i + '.png',
