ps.math.boulieradditionner.View = function (mdl, div, max) {
...
// public methods
    ...
    this.init = function (mdl, view) {
        ...
        module = mdl;
        model = new ps.math.boulieradditionner.Model(mdl, max);
        init_div(view);

        controller = new ps.math.boulieradditionner.Controller(model, this);
    };
