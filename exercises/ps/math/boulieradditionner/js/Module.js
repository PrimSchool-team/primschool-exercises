ps.math.boulieradditionner.Module = function (e) {
...
// public methods
    this.buildExercisePresentation = function (div) {
        ...
        var illustration = $('<img/>', {
            src: 'exercises/ps/math/boulieradditionner/img/illustration.png',
            style: 'width:80%'
        });
    ...
    this.buildExplanation = function (div, currentExercise) {
        ...
        var img_Exercise = $('<img>', {
            src: 'exercises/ps/math/boulieradditionner/img/explanation_exercice1.jpg',
            style: 'width:80%'
        });
    ...
    this.buildQuestion = function (div, currentExercise, currentModule) {
        if (currentExercise == 1) {
            view = new ps.math.boulieradditionner.View(this, div, 5);
        }
        else if (currentExercise == 2) {
            view = new ps.math.boulieradditionner.View(this, div, 9);
        }
        else if (currentExercise == 3) {
            view = new ps.math.boulieradditionner.View(this, div, 12);
        }
        questionIndex = 1;
