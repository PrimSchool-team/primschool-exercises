ms.divers.trajet.Arrow = function () {
...
// public methods
    ...
    this.drawWithCoordinates = function (context, x, y, length, length2) {
        ...
        context.beginPath();
        switch (direction) {
            case ms.divers.trajet.Direction.NORTH:
                ...
                context.lineTo(x + l2, y - length + l);
                break;
            case ms.divers.trajet.Direction.EAST:
                ...
                break;
            case ms.divers.trajet.Direction.SOUTH:
                pt2 = { x: x, y: y + length - l };
                ...
                context.lineTo(x - l2, y + length - l);
                break;
            case ms.divers.trajet.Direction.WEST:
                pt2 = { x: x - length + l, y: y };
                ...
                context.lineTo(x - length + l, y - l2);
                break;
            case ms.divers.trajet.Direction.UNDEFINED:
/*                context.strokeStyle = "#ff0000";
        ...
        if (direction != ms.divers.trajet.Direction.UNDEFINED) {
            context.fill();
            context.stroke();
            context.closePath();
            context.lineWidth = 3.;
...
ms.divers.trajet.View = function (mdl, div, n, m, min, max) {
...
// public methods
    ...
    this.init = function (mdl, view, n, m, min, max) {
        ...
        maxSize = max;
        module = mdl;
        model = new ms.divers.trajet.Model(ncolumn, nline, minSize, maxSize);
        init_div(view);
        controller = new ms.divers.trajet.Controller(model, this);
    };
    ...
    var draw_grid_and_path = function(context) {
        for (var i = 0; i < model.size(); ++i) {
            ...
            if (a.getDirection() == ms.divers.trajet.Direction.NORTH
                || a.getDirection() == ms.divers.trajet.Direction.SOUTH)
